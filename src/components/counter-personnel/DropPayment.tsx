...
// API
const dropConsumer = process.env.BACKEND_API_CONSUMER_TRANSACT;
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await axios.get(
        `${dropConsumer}/transactionstatus?transactionType=3&transactionStatus=4`,
        {
          headers: {
  ...
  return (
    <div className="flex flex-col flex-grow my-1">
      ...
      <button
        ...
        className="bg-white text-gray-800 mx-2 my-2 py-2 border border-blue-900 flex items-center rounded-md hover:shadow-lg hover:bg-blue-800 hover:text-white transition-all font-poppins font-medium text-xl container"
      >
