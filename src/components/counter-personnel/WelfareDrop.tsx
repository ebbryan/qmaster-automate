...
const dropCurrentDate = process.env.BACKEND_API_DROP_CURRENT_DATE_API;
//API
...
export const WelfareDrop: FunctionComponent<ConsumerProps> = () => {
  ...
  return (
    ...
    //           onChange={handleInputChange}
    //           placeholder="Search consumers..."
    //           className="px-7 py-1 my-2 uppercase text-lg rounded-md"
    //         />
    //       </td>
    //     </tr>
    //   </thead>
